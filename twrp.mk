...
PRODUCT_COPY_FILES += \
    vendor/xiaomi/jasmine_sprout/proprietary/vendor/lib64/libdiag.so:$(TARGET_COPY_OUT_RECOVERY)/root/vendor/lib64/libdiag.so \
    vendor/xiaomi/jasmine_sprout/proprietary/vendor/lib64/libtime_genoff.so:$(TARGET_COPY_OUT_RECOVERY)/root/vendor/lib64/libtime_genoff.so \
    vendor/xiaomi/jasmine_sprout/proprietary/vendor/lib64/libidl.so:$(TARGET_COPY_OUT_RECOVERY)/root/vendor/lib64/libidl.so \
    vendor/xiaomi/jasmine_sprout/proprietary/vendor/firmware/dbmd4_va_fw.bin:$(TARGET_COPY_OUT_RECOVERY)/root/vendor/firmware/dbmd4_va_fw.bin \
    vendor/xiaomi/jasmine_sprout/proprietary/vendor/firmware/tas2557_uCDSP.bin:$(TARGET_COPY_OUT_RECOVERY)/root/vendor/firmware/tas2557_uCDSP.bin \
    vendor/xiaomi/jasmine_sprout/proprietary/vendor/lib64/libssd.so:$(TARGET_COPY_OUT_RECOVERY)/root/vendor/lib64/libssd.so \
